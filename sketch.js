    ...
    function preload() {
      ...
      sprite_sheet = loadSpriteSheet('assets/idlemansitting.png', 32, 32, 2);
      ...
      sprite_sheet = loadSpriteSheet('assets/angry.png', 32, 32, 10);
      angry_animation = loadAnimation(sprite_sheet);
      ...
      //load sound
      eat_sound = loadSound("assets/baby1.wav");
      barf_sound = loadSound("assets/angel.wav");
      hunger_sound = loadSound("assets/angrygrowl.wav");
      die_sound = loadSound("assets/devil.wav");
...
barf_animation.frameDelay = 10;
    ...
    function setup() {
      ...
      character.addAnimation('angry', angry_animation);
      ...
      feed.onMousePressed = function() {
        ...
        //feed only if the animation is idle or angry to avoid cutting off the other animations
        if (character.getAnimationLabel() == "idle" || character.getAnimationLabel() == "angry") {
